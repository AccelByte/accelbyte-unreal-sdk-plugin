...
void UAccelByteBlueprintsCurrency::GetCurrencyList(const FString& Namespace, EAccelByteCurrencyType CurrencyType, const FGetCurrencyListSuccess& OnSuccess, const FBlueprintErrorHandler& OnError)
{
