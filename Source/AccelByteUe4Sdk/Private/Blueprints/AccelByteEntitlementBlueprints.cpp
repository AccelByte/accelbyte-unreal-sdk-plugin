...
void UAccelByteBlueprintsEntitlement::QueryUserEntitlements(const FString & EntitlementName
	, const FString & ItemId
	, int32 Page
	, int32 Size
	, const FQueryUserEntitlementSuccess& OnSuccess
...
{
	FRegistry::Entitlement.QueryUserEntitlements(EntitlementName
		, ItemId
		, Page
		, Size
		, THandler<FAccelByteModelsEntitlementPagingSlicedResult>::CreateLambda(
			[OnSuccess](const FAccelByteModelsEntitlementPagingSlicedResult& Result)
			{
