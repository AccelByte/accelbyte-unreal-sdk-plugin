...
// Setup variables.
TArray<FString> ReportingReasonsTest = { TEXT("ReasonTest1"), TEXT("ReasonTest2"), TEXT("ReasonTest3") };
TArray<FString> ReportingReasonGroupsTest = { TEXT("ReasonGroupTest1"), TEXT("ReasonGroupTest2")};
...
bool ReportingGetReasons::RunTest(const FString& Parameters)
{
	...
	FString ReasonGroup = "";
	FRegistry::Reporting.GetReasons(ReasonGroup,THandler<FAccelByteModelsReasonsResponse>::CreateLambda([&bGetReasonsSuccess, &ReasonsResponse](const FAccelByteModelsReasonsResponse& Response)
	{
		UE_LOG(LogAccelByteReportingTest, Log, TEXT("Get reasons Success"));
		ReasonsResponse = Response;
		bGetReasonsSuccess = true;
...
bool ReportingGetReasons_WithReasonGroup::RunTest(const FString& Parameters)
{
	...
	FRegistry::Reporting.GetReasonGroups(THandler<FAccelByteModelsReasonGroupsResponse>::CreateLambda([&bGetReasonGroupsSuccess, &ReasonGroupsResponse](const FAccelByteModelsReasonGroupsResponse& Response)
		{
	...
	FRegistry::Reporting.GetReasons(ReasonGroupsResponse.Data[0].Title, THandler<FAccelByteModelsReasonsResponse>::CreateLambda([&bGetReasonsSuccess_Group1, &ReasonsResponse_Group1](const FAccelByteModelsReasonsResponse& Response)
		{
			UE_LOG(LogAccelByteReportingTest, Log, TEXT("Get reasons Success"));
	...
	FRegistry::Reporting.GetReasons(ReasonGroupsResponse.Data[1].Title, THandler<FAccelByteModelsReasonsResponse>::CreateLambda([&bGetReasonsSuccess_Group2, &ReasonsResponse_Group2](const FAccelByteModelsReasonsResponse& Response)
		{
			UE_LOG(LogAccelByteReportingTest, Log, TEXT("Get reasons Success"));
