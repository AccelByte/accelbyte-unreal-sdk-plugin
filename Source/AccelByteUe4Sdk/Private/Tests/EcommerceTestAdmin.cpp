...
#pragma region CreatePurchasingItem
	...
	*/
	...
	Ecommerce_Item_Create(purchaseItemRequest, CreatedTemporaryStoreInfo.storeId, THandler<FItemFullInfo>::CreateLambda([&bPurchasingItemCreated](const FItemFullInfo& Result)
		{
