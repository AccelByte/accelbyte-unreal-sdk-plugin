...
BEGIN_DEFINE_SPEC(FAchievementTestSpec, "AccelByte.Tests.Achievement", EAutomationTestFlags::ProductFilter | EAutomationTestFlags::ApplicationContextMask)
	FTestUser TestUser;
...
END_DEFINE_SPEC(FAchievementTestSpec)
...
void FAchievementTestSpec::Define()
{
	Describe("A.Setup", [this]()
	{
	...
	Describe("B.GetAchievement", [this]()
	{
		It("Should get achievement and fail if achievementCode empty or invalid ", [this]()
		{
	...
	Describe("B.QueryAchievements", [this]()
	{
		It("Should return achievement", [this]()
		{
			//QueryAchievementsLimit1
			FAccelByteModelsPaginatedPublicAchievement paginatedAchievementsLimit1;

			AB_TEST_TRUE(AchievementTestQueryAchievements(TEXT(""), EAccelByteAchievementListSortBy::NONE, paginatedAchievementsLimit1, 0, 1));
			AB_TEST_EQUAL(paginatedAchievementsLimit1.Data.Num(), 1);

			//QueryAchievementsOffset1
			FAccelByteModelsPaginatedPublicAchievement paginatedAchievementsOffset1;

			AchievementTestQueryAchievements(TEXT(""), EAccelByteAchievementListSortBy::CREATED_AT_ASC, paginatedAchievementsOffset1, 1);
			...
			AB_TEST_EQUAL(paginatedAchievementsOffset1.Data[0].AchievementCode, paginatedAchievementsNoOffset.Data[1].AchievementCode);

			//QueryUserAchievementsEmptyData

			FAccelByteModelsPaginatedUserAchievement paginatedAchievementsEmptyData;

			AB_TEST_TRUE(AchievementTestQueryUserAchievements(EAccelByteAchievementListSortBy::NONE, paginatedAchievementsEmptyData));

			AB_TEST_EQUAL(paginatedAchievementsEmptyData.Data.Num(), 0);

			return true;
		});
	});

	Describe("B.QueryAchievementsCreatedAscAndDesc", [this]()
	{
		It("Should queriy achievements created sorted Ascending and Descending", [this]()
		{
			//QueryAchievementsCreatedAsc
			FAccelByteModelsPaginatedPublicAchievement paginatedAchievementsAsc;

			AB_TEST_TRUE(AchievementTestQueryAchievements(TEXT(""), EAccelByteAchievementListSortBy::CREATED_AT_ASC, paginatedAchievementsAsc, 0, 100));

			int achievement1Order = 0;
			bool bAchievement1Found = false;
			for (int i = 0; i < paginatedAchievementsAsc.Data.Num(); i++)
			{
				if (paginatedAchievementsAsc.Data[i].AchievementCode == AchievementTestAchievement1.AchievementCode)
				{
					achievement1Order = i;
			...
			for (int i = 0; i < paginatedAchievementsAsc.Data.Num(); i++)
			{
				if (paginatedAchievementsAsc.Data[i].AchievementCode == AchievementTestAchievement2.AchievementCode)
				{
					achievement2Order = i;
			...
			//QueryAchievementsCreatedDesc
			FAccelByteModelsPaginatedPublicAchievement paginatedAchievementsDesc;

			AB_TEST_TRUE(AchievementTestQueryAchievements(TEXT(""), EAccelByteAchievementListSortBy::CREATED_AT_DESC, paginatedAchievementsDesc, 0, 100));

			achievement1Order = 0;
			bAchievement1Found = false;
			for (int i = 0; i < paginatedAchievementsDesc.Data.Num(); i++)
			{
				if (paginatedAchievementsDesc.Data[i].AchievementCode == AchievementTestAchievement1.AchievementCode)
				{
					achievement1Order = i;
					bAchievement1Found = true;
					break;
			...
			achievement2Order = 0;
			bAchievement2Found = false;
			for (int i = 0; i < paginatedAchievementsDesc.Data.Num(); i++)
			{
				if (paginatedAchievementsDesc.Data[i].AchievementCode == AchievementTestAchievement2.AchievementCode)
				{
					achievement2Order = i;
					bAchievement2Found = true;
					break;
	...
	Describe("B.QueryAchievementsByLanguage", [this]()
	{
		It("Should query achievements created by default language and/or specific language", [this]()
		{
			//QueryAchievementsDefaultLanguage
			...
			//QueryAchievementsSpecificLanguage
	...
	Describe("C.UnlockAchievement", [this]()
	{
		It("Should unlock achievement", [this]()
		{
	...
	Describe("D.QueryUserAchievements", [this]()
	{
		It("Should return user achievements", [this]()
		{
	...
	Describe("E.ServerUnlockAchievement", [this]()
	{
		It("Should unlock achievement to user and fail to unlock if code or userId was empty/invalid", [this]()
		{
	...
	Describe("F.QueryUserAchievements", [this]()
	{
		It("Should query achievements of user", [this]()
		{
			//QueryUserAchievementsLimit1
			FAccelByteModelsPaginatedUserAchievement paginatedAchievementsLimit1;

			AB_TEST_TRUE(AchievementTestQueryUserAchievements(EAccelByteAchievementListSortBy::CREATED_AT_ASC, paginatedAchievementsLimit1, 0, 1));

			AB_TEST_EQUAL(paginatedAchievementsLimit1.Data.Num(), 1);
			AB_TEST_EQUAL(paginatedAchievementsLimit1.Data[0].AchievementCode, AchievementTestAchievement1.AchievementCode);

			//QueryUserAchievementsOffset1
			FAccelByteModelsPaginatedUserAchievement paginatedAchievementsOffset1;

			AB_TEST_TRUE(AchievementTestQueryUserAchievements(EAccelByteAchievementListSortBy::CREATED_AT_ASC, paginatedAchievementsOffset1, 1));

			AB_TEST_EQUAL(paginatedAchievementsOffset1.Data.Num(), 1);
			AB_TEST_EQUAL(paginatedAchievementsOffset1.Data[0].AchievementCode, AchievementTestAchievement2.AchievementCode);

			//QueryUserAchievementsUnlockedAll
			FAccelByteModelsPaginatedUserAchievement paginatedAchievements;
	...
	Describe("G.UnlockIncrementalAchievementClientUpdateStat", [this]()
	{
		It("Should increment user stat and unlock achievement", [this]()
		{
			// Arrange
			...
			DelaySeconds(10.0f, "Waiting for KAFKA");
	...
	Describe("G.UnlockIncrementalAchievementServerUpdateStat", [this]()
	{
		It("Should increment user stat and unlock achievement by server", [this]()
		{
			bool bClientLoginSuccess = false;
	...
	Describe("Z.Teardown", [this]()
	{
		It("Should clean up test config", [this]()
		{
