...
public:
	 ...
	 */
	void GetLegalPolicies(EAccelByteAgreementPolicyType const& AgreementPolicyType
		, bool DefaultOnEmpty
	 ...
	 * @param OnError This will be called when the operation failed.
	 */
	void GetLegalPolicies(FString const& Namespace
	 ...
	 * @param OnError This will be called when the operation failed.
	 */
	void GetLegalPoliciesByCountry(FString const& CountryCode
		, EAccelByteAgreementPolicyType const& AgreementPolicyType
		, bool DefaultOnEmpty
		, THandler<TArray<FAccelByteModelsPublicPolicy>> const& OnSuccess
		, FErrorHandler const& OnError);
	 ...
	 * @param OnError This will be called when the operation failed.
	 */
	void BulkAcceptPolicyVersions(TArray<FAccelByteModelsAcceptAgreementRequest> const& AgreementRequests
	 ...
	 * @param OnError This will be called when the operation failed.
	 */
	void AcceptPolicyVersion(FString const& LocalizedPolicyVersionId
	 ...
	 * @param OnError This will be called when the operation failed.
	 */
	void QueryLegalEligibilities(FString const& Namespace
	 ...
	 * @param OnError This will be called when the operation failed.
	 */
	void GetLegalDocument(FString const& Url
