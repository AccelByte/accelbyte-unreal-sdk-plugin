...
public:
	...
	* @param OnSuccess This will be called when the operation succeeded. The result is an array of FAccelByteModelsBulkUpdateMultipleUserStatItemsResponse.
	* @param OnError This will be called when the operation failed.
	*/	
	...
	* @param OnError This will be called when the operation failed.
	*/		
	void BulkUpdateUserStatItemsValue(const FString& AdditionalKey, const TArray<FAccelByteModelsBulkUpdateUserStatItem>& BulkUpdateUserStatItems,
	...
	* @param OnSuccess This will be called when the operation succeeded. The result is an array of FAccelByteModelsUpdateUserStatItemValueRespose.
	* @param OnError This will be called when the operation failed.
	*/	
