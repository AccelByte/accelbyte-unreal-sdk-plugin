...
public:
     ...
     *
     * @param Availability the presence state that you want to use in the EAvailability type
     * @param Activity any string which explains the activity of the player
     */
