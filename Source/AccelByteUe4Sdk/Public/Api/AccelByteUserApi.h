...
#pragma endregion /Login Methods
	 ...
	 * @param Code If mandatoryEmailVerificationEnabled config is enabled, this param is required. Retrieved from user email. Use SendVerificationCodeToNewUser for sending the code to user email.
	 * 
	 * @return AccelByteTask object to track and cancel the ongoing API operation.
	 */
	 ...
	 * @param OnSuccess This will be called when the operation succeeded.
	 * @param OnError This will be called when the operation failed.
	 * @param Request [Optional] Token retrieved from multi-factor authentication challenge. Only needed if multi-factor authentication is enabled.
	 * 
	 * @return AccelByteTask object to track and cancel the ongoing API operation.
	 */
	 ...
	 * @param OnSuccess This will be called when the operation succeeded.
	 * @param OnError This will be called when the operation failed.
	 * @param Code The code generated by authenticator app.
	 * 
	 * @return AccelByteTask object to track and cancel the ongoing API operation.
	 */
	 ...
	 * @return AccelByteTask object to track and cancel the ongoing API operation.
	 */
	FAccelByteTaskWPtr UpdatePassword(FUpdatePasswordRequest const& Request
		, FVoidHandler const& OnSuccess
		, FErrorHandler const& OnError);

	/**
	 * @brief Enable multi-factor authentication with email.
	 *
	 * @param Code Verification code received from user email.
	 * @param OnSuccess This will be called when the operation succeeded.
	 * @param OnError This will be called when the operation failed.
	 * 
	 * @return AccelByteTask object to track and cancel the ongoing API operation.
	 */
	FAccelByteTaskWPtr EnableMfaEmail(FString const& Code
		, FVoidHandler const& OnSuccess
		, FErrorHandler const& OnError);

	/**
	 * @brief Disable multi-factor authentication with email.
	 *
	 * @param OnSuccess This will be called when the operation succeeded.
	 * @param OnError This will be called when the operation failed.
	 * @param Request [Optional] Token retrieved from multi-factor authentication challenge. Only needed if multi-factor authentication is enabled.
	 ...
	 * @return AccelByteTask object to track and cancel the ongoing API operation.
	 */
	FAccelByteTaskWPtr DisableMfaEmail(FVoidHandler const& OnSuccess
		, FErrorHandler const& OnError
		, FDisableMfaEmailRequest const& Request = {});

	/**
	 * @brief Send multi-factor authentication code to email.
	 *
	 ...
	 * @return AccelByteTask object to track and cancel the ongoing API operation.
	 */
	FAccelByteTaskWPtr SendMfaCodeToEmail(const EAccelByteSendMfaEmailAction Action
		, FVoidHandler const& OnSuccess
		, FErrorHandler const& OnError);

	/**
	 * @brief Get multi-factor authentication status for current user.
	 *
	 * @param OnSuccess This will be called when the operation succeeded.
	 * @param OnError This will be called when the operation failed.
	 * 
	 * @return AccelByteTask object to track and cancel the ongoing API operation.
	 */
	FAccelByteTaskWPtr GetMfaStatus(THandler<FMfaStatusResponse> const& OnSuccess
		, FErrorHandler const& OnError);
	
	/**
	 * @brief Verify code from MFA to retrieve MFA Token.
	 *
	 * @param Factor Factor used for multi-factor authentication (e.g. email, backup codes or authenticator app).
	 * @param Code The code received from multi-factor authentication.
	 * @param OnSuccess This will be called when the operation succeeded.
	 * @param OnError This will be called when the operation failed.
	 * 
	 * @return AccelByteTask object to track and cancel the ongoing API operation.
	 */
	FAccelByteTaskWPtr VerifyMfaCode(EAccelByteLoginAuthFactorType const& Factor
		, FString const& Code
	 ...
	 * 
	 * @param Request The request for sending a new user a verification code to email.
	 * @param OnSuccess This will be called when the operation succeeded. The result is bool.
	 * @param OnError This will be called when the operation failed.
	 * 
	 * @return AccelByteTask object to track and cancel the ongoing API operation.
	 */
	FAccelByteTaskWPtr SendVerificationCodeToNewUser(FSendVerificationCodeToNewUserRequest const& Request
		, FVoidHandler const& OnSuccess
		, FErrorHandler const& OnError);
...
private:
	 ...
	 * @param ExpireDate The expiry date. 
	 */
