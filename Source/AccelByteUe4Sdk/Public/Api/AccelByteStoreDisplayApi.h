...
namespace Api
{
	...
	*/
	...
	public:
		...
		*/
		void GetAllViews(FString const& StoreId, FString const& Language, THandler<TArray<FAccelByteModelsViewInfo>> const& OnSuccess, FErrorHandler const& OnError);
		...
		* @param OnError This will be called when the operation failed.
		*/
		void ListActiveSectionContents(FString const& StoreId, FString const& ViewId, FString const& Language, FString const& Region,
			THandler<TArray<FAccelByteModelsSectionInfo>> const& OnSuccess, FErrorHandler const& OnError);
