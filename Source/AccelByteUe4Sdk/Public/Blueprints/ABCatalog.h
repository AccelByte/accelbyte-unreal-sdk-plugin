...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "AccelByte | Catalog")
	void GetItemsByCriteria(FAccelByteModelsItemCriteria const& ItemCriteria, int32 const& Offset, int32 const& Limit, TArray<EAccelByteItemListSortBy> const& SortBy, FDModelsItemPagingSlicedResultResponse OnSuccess, FDErrorHandler OnError);
