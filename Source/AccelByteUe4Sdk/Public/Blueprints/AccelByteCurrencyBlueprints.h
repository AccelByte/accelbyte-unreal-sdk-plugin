...
public:
	...
	static void GetCurrencyList(const FString& Namespace, EAccelByteCurrencyType CurrencyType, const FGetCurrencyListSuccess& OnSuccess, const FBlueprintErrorHandler& OnError);
};