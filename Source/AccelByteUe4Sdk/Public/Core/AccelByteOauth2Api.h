...
public:
	 ...
	 * @param OnError This will be called when the operation failed.
	 */
	static void GetTokenWithAuthorizationCode(const FString& IamUrl, const FString& ClientId, const FString& ClientSecret, const FString& AuthorizationCode, const FString& RedirectUri, const THandler<FOauth2Token>& OnSuccess, const FErrorHandler& OnError);
	 ...
	 * @param OnError This will be called when the operation failed.
	 */
	static void GetTokenWithPasswordCredentials(const FString& IamUrl, const FString& ClientId, const FString& ClientSecret, const FString& Username, const FString& Password, const THandler<FOauth2Token>& OnSuccess, const FErrorHandler& OnError);
	 ...
	 * @param OnError This will be called when the operation failed.
	 */
	static void GetTokenWithPasswordCredentials(const FString& IamUrl, const FString& ClientId, const FString& ClientSecret, const FString& Username, const FString& Password, const THandler<FOauth2Token>& OnSuccess, const FCustomErrorHandler& OnError);
	 ...
	 * @param OnError This will be called when the operation failed.
	 */
	static void GetTokenWithClientCredentials(const FString& IamUrl, const FString& ClientId, const FString& ClientSecret, const THandler<FOauth2Token>& OnSuccess, const FErrorHandler& OnError);
	 ...
	 * @param OnError This will be called when the operation failed.
	 */
	static void GetTokenWithDeviceId(const FString& IamUrl, const FString& ClientId, const FString& ClientSecret, const THandler<FOauth2Token>& OnSuccess, const FErrorHandler& OnError);
	 ...
	 * @param OnError This will be called when the operation failed.
	 */
	static void GetTokenWithOtherPlatformToken(const FString& IamUrl, const FString& ClientId, const FString& ClientSecret, const FString& PlatformId, const FString& PlatformToken, const THandler<FOauth2Token>& OnSuccess, const FErrorHandler& OnError);
	 ...
	 * @param bCreateHeadless This will create new account if needed, default value is true 
	 */
	static void GetTokenWithOtherPlatformToken(const FString& IamUrl, const FString& ClientId, const FString& ClientSecret, const FString& PlatformId, const FString& PlatformToken,
		const THandler<FOauth2Token>& OnSuccess, const FCustomErrorHandler& OnError, bool bCreateHeadless = true);
	 ...
	 * @param ClientId The issued OAuth2 client credentials.
	 * @param ClientSecret The issued OAuth2 client credentials.
	 * @param RefreshToken The issued Refresh Token during get user session.
	 * @param OnSuccess This will be called when the operation succeeded.
	 * @param OnError This will be called when the operation failed.
	 */
	static void GetTokenWithRefreshToken(const FString& ClientId, const FString& ClientSecret, const FString& RefreshToken,
	 ...
	 * @param OnError This will be called when the operation failed.
	 */
	static void GetTokenWithRefreshToken(const FString& IamUrl, const FString& ClientId, const FString& ClientSecret,
		const FString& RefreshToken, const THandler<FOauth2Token>& OnSuccess, const FErrorHandler& OnError);
	 ...
	 * @param OnError This will be called when the operation failed.
	 */
	static void RevokeToken(const FString& IamUrl, const FString& AccessToken, const FVoidHandler& OnSuccess, const FErrorHandler& OnError);
	 ...
	 * @param OnError This will be called when the operation failed.
	 */
	static void RevokeUserToken(const FString& ClientId, const FString& ClientSecret, const FString& AccessToken,
	 ...
	 * @param OnError This will be called when the operation failed.
	 */
	static void RevokeUserToken(const FString& IamUrl, const FString& ClientId, const FString& ClientSecret,
		const FString& AccessToken, const FVoidHandler& OnSuccess, const FErrorHandler& OnError);
	 ...
	 * @param OnError This will be called when the operation failed.
	 */
	static void GetTokenWithAuthorizationCodeV3(const FString& ClientId, const FString& ClientSecret, const FString& AuthorizationCode,
		const FString& RedirectUri, const THandler<FOauth2Token>& OnSuccess, const FErrorHandler& OnError);
	 ...
	 * @param OnError This will be called when the operation failed.
	 */
	static void GetTokenWithAuthorizationCodeV3(const FString& IamUrl, const FString& ClientId, const FString& ClientSecret,
		const FString& AuthorizationCode, const FString& RedirectUri, const THandler<FOauth2Token>& OnSuccess, const FErrorHandler& OnError);
	 ...
	 */
	static void GetTokenWithPasswordCredentialsV3(const FString& ClientId, const FString& ClientSecret, const FString& Username,
		const FString& Password, const THandler<FOauth2Token>& OnSuccess, const FErrorHandler& OnError, bool bRememberMe = false);
	 ...
	 * @param bRememberMe This will use for refresh token expiration extension, default value is false.
	 */
	static void GetTokenWithPasswordCredentialsV3(const FString& IamUrl, const FString& ClientId, const FString& ClientSecret,
		const FString& Username, const FString& Password, const THandler<FOauth2Token>& OnSuccess, const FErrorHandler& OnError, bool bRememberMe = false);
	 ...
	 */
	static void GetTokenWithPasswordCredentialsV3(const FString& ClientId, const FString& ClientSecret, const FString& Username,
		const FString& Password, const THandler<FOauth2Token>& OnSuccess, const FCustomErrorHandler& OnError, bool bRememberMe = false);
	 ...
	 */
	static void GetTokenWithPasswordCredentialsV3(const FString& IamUrl, const FString& ClientId, const FString& ClientSecret,
		const FString& Username, const FString& Password, const THandler<FOauth2Token>& OnSuccess, const FCustomErrorHandler& OnError, bool bRememberMe = false);
	 ...
	 */
	static void VerifyAndRememberNewDevice(const FString& ClientId, const FString& ClientSecret, const FString& MfaToken,
		EAccelByteLoginAuthFactorType AuthFactorType, const FString& Code, 
	 ...
	 * @param bRememberDevice This will use for refresh token expiration extension, default value is false.
	 */
	static void VerifyAndRememberNewDevice(const FString& IamUrl, const FString& ClientId, const FString& ClientSecret,
		const FString& MfaToken, EAccelByteLoginAuthFactorType AuthFactorType, const FString& Code, 
		const THandler<FOauth2Token>& OnSuccess, const FCustomErrorHandler& OnError, bool bRememberDevice = false);
	 ...
	 * @param OnError This will be called when the operation failed.
	 */
	static void CreateHeadlessAccountAndResponseToken(const FString& IamUrl, const FString& ClientId, const FString& ClientSecret, const FString& LinkingToken,
		const THandler<FOauth2Token>& OnSuccess, const FCustomErrorHandler& OnError);
	 ...
	 * @param OnError This will be called when the operation failed.
	 */
	static void AuthenticationWithPlatformLink(const FString& IamUrl, const FString& ClientId, const FString& ClientSecret, const FString& Username, const FString& Password, const FString& LinkingToken,
		const THandler<FOauth2Token>& OnSuccess, const FCustomErrorHandler& OnError);
