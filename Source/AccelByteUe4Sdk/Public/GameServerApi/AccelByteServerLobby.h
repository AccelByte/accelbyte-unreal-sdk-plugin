...
public:
	 ...
	 */
	void GetPartyDataByUserId(const FString& UserId
	 ...
	 * @param OnError This will be called when the operation failed.
	 */
	void GetSessionAttributeAll(const FString& UserId
	 ...
	 * @param OnError This will be called when the operation failed.
	 */
	void GetSessionAttribute(const FString& UserId
		, const FString& Key
	 ...
	 * @param OnError This will be called when the operation failed.
	 */
	void SetSessionAttribute(const FString& UserId
...
private:
	...
	void RequestWritePartyStorage(const FString& PartyId
