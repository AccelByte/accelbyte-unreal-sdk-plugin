...
::::Packaging Plugin
"%ENGINE_PATH%\Engine\Build\BatchFiles\RunUAT.bat" BuildPlugin -Plugin="D:\JUSTICE\ue4\Plugins\AccelByteUe4Sdk\AccelByteUe4Sdk.uplugin" -Package="%WORKSPACE%\temp\plugin" -Rocket