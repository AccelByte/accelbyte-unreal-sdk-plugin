 ...
 */
class FOnlineSessionJustice : public IOnlineSession
{
private:
	 ...
	 */
	void AppendSessionToPacket(class FNboSerializeToBufferJustice& Packet, class FOnlineSession* Session);
	 ...
	 */
	void AppendSessionSettingsToPacket(class FNboSerializeToBufferJustice& Packet, FOnlineSessionSettings* SessionSettings);
	 ...
	 */
	void ReadSessionFromPacket(class FNboSerializeFromBufferJustice& Packet, class FOnlineSession* Session);
	 ...
	 * @param SessionSettings the session settings to copy the data to
	 */
	void ReadSettingsFromPacket(class FNboSerializeFromBufferJustice& Packet, FOnlineSessionSettings& SessionSettings);
	 ...
	 */
	static void SetPortFromNetDriver(const FOnlineSubsystemJustice& Subsystem, const TSharedPtr<FOnlineSessionInfo>& SessionInfo);
...
PACKAGE_SCOPE:
	...
	FOnlineSessionJustice(class FOnlineSubsystemJustice* InSubsystem) :
...
typedef TSharedPtr<FOnlineSessionJustice, ESPMode::ThreadSafe> FOnlineSessionJusticePtr;
