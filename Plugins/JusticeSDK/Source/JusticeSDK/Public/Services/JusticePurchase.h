...
DECLARE_DELEGATE_ThreeParams(FGetUserOrderCompleteDelegate, bool, FString, OrderInfo);
DECLARE_DELEGATE_ThreeParams(FGetUserOrdersCompleteDelegate, bool, FString, TArray<OrderInfo>);
DECLARE_DELEGATE_ThreeParams(FFulfillOrderCompleteDelegate, bool, FString, OrderInfo);
...
public:
	static void CreateNewOrder(FString ItemID, int32 Price, int32 DiscountedPrice, FString Currency, FCreateNewOrderCompleteDelegate OnComplete);
	static void GetUserOrder(FString OrderNo, FGetUserOrderCompleteDelegate OnComplete);
	static void GetUserOrders(int32 Page, int32 Size, FGetUserOrdersCompleteDelegate OnComplete);
	static void FulfillOrder(FString OrderNo, FFulfillOrderCompleteDelegate OnComplete);
...
private:
	...
	static void OnGetUserOrderResponse(FJusticeHttpResponsePtr Response, FGetUserOrderCompleteDelegate OnComplete);
	static void OnGetUserOrdersResponse(FJusticeHttpResponsePtr Response, FGetUserOrdersCompleteDelegate OnComplete);
	static void OnFulfillOrderResponse(FJusticeHttpResponsePtr Response, FFulfillOrderCompleteDelegate OnComplete);
