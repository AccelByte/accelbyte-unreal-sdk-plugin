...
{
	JusticeCatalog::GetChildCategory(this->Language, this->CategoryPath, FGetChildCategoryCompleteDelegate::CreateLambda([&](bool bSuccessful, FString ErrorString, TArray<Category> Result) {
