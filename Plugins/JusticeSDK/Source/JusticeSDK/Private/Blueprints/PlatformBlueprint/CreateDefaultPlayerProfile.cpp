...
{
	JusticePlatform::CreateDefaultPlayerProfile(this->Email, this->DisplayName, FUpdatePlayerProfileCompleteDelegate::CreateLambda([&](bool IsSuccess, FString ErrorStr) {
		if (IsSuccess)
		{
