...
void UserAuthentication::LoginWithClientCredentials(FString ServerBaseUrl, FString ClientId, FString ClientSecret, FLoginWithClientCredentialsSuccess OnSuccess, ErrorDelegate OnError)
{
...
void UserAuthentication::LoginWithClientCredentialsEasy(FLoginWithClientCredentialsSuccess OnSuccess, ErrorDelegate OnError)
{
	LoginWithClientCredentials(Settings::ServerBaseUrl, Settings::ClientId, Settings::ClientSecret, OnSuccess, OnError);
}

void UserAuthentication::LoginWithOtherPlatformAccount(FString ServerBaseUrl, FString ClientId, FString ClientSecret, std::underlying_type<EPlatformType>::type PlatformId, FString PlatformToken, FLoginWithOtherPlatformAccountSuccess OnSuccess, ErrorDelegate OnError)
{
...
void UserAuthentication::LoginWithOtherPlatformAccountEasy(std::underlying_type<EPlatformType>::type PlatformId, FString PlatformToken, FLoginWithOtherPlatformAccountSuccess OnSuccess, ErrorDelegate OnError)
{
...
void UserAuthentication::LoginWithUsernameAndPassword(FString ServerBaseUrl, FString ClientId, FString ClientSecret, FString Username, FString Password, FLoginWithUsernameAndPasswordSuccess OnSuccess, ErrorDelegate OnError)
{
...
void UserAuthentication::LoginWithUsernameAndPasswordEasy(FString Username, FString Password, FLoginWithUsernameAndPasswordSuccess OnSuccess, ErrorDelegate OnError)
{
...
void UserAuthentication::LoginWithDeviceId(FString ServerBaseUrl, FString ClientId, FString ClientSecret, FLoginWithDeviceIdSuccess OnSuccess, ErrorDelegate OnError)
{
...
void UserAuthentication::LoginWithDeviceIdEasy(FLoginWithDeviceIdSuccess OnSuccess, ErrorDelegate OnError)
{
