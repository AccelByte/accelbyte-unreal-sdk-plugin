...
void Order::CreateNewOrderEasy(const FAccelByteModelsOrderCreate& OrderCreate, FCreateNewOrderSuccess OnSuccess, ErrorDelegate OnError)
{
...
void Order::GetUserOrderEasy(FString OrderNo, FGetUserOrderSuccess OnSuccess, ErrorDelegate OnError)
{
...
void Order::GetUserOrdersEasy(int32 Page, int32 Size, FGetUserOrdersSuccess OnSuccess, ErrorDelegate OnError)
{
...
void Order::FulfillOrderEasy(FString OrderNo, FFulfillOrderSuccess OnSuccess, ErrorDelegate OnError)
{
...
void Order::GetUserOrderHistoryEasy(FString OrderNo, FGetUserOrderHistorySuccess OnSuccess, ErrorDelegate OnError)
{
