...
namespace EJusticeHttpResponseCodes
{
	/**
 ...
 */
class IJusitceHttpResponse : public IJusticeHttpBase
{
public:

	/**
	 * Gets the response code returned by the requested server.
	 * See EJusticeHttpResponseCodes for known response codes
	 *
