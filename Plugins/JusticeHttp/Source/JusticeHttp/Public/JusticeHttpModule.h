...
public:
	 ...
	 */
	JUSTICEHTTP_API static FJusticeHttpModule& Get();
	 ...
	 */
	virtual TSharedRef<IJusticeHttpRequest> CreateRequest();
...
private:
	...
	static FJusticeHttpModule* Singleton;
};
