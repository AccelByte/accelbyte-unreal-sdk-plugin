 ...
 */
class FGenericPlatformHttpRequest : public IJusticeHttpRequest
{
public:
	// IJusticeHttpBase
	...
	virtual FJusticeHttpRequestCompleteDelegate& OnProcessRequestComplete() override { static FJusticeHttpRequestCompleteDelegate RequestCompleteDelegate; return RequestCompleteDelegate; }
	virtual FJusticeHttpRequestProgressDelegate& OnRequestProgress() override { static FJusticeHttpRequestProgressDelegate RequestProgressDelegate; return RequestProgressDelegate; }
	virtual void CancelRequest() override {}
	virtual EJusticeHttpRequestStatus::Type GetStatus() override { return EJusticeHttpRequestStatus::NotStarted; }
	virtual const FJusticeHttpResponsePtr GetResponse() const override { return nullptr; }
	virtual void Tick(float DeltaSeconds) override {}
	virtual float GetElapsedTime() override { return 0.0f; }
};


void FGenericPlatformJusticeHttp::Init()
{
}


void FGenericPlatformJusticeHttp::Shutdown()
{
}


IJusticeHttpRequest* FGenericPlatformJusticeHttp::ConstructRequest()
{
...
FString FGenericPlatformJusticeHttp::UrlEncode(const FString &UnencodedString)
{
...
FString FGenericPlatformJusticeHttp::UrlDecode(const FString &EncodedString)
{
...
FString FGenericPlatformJusticeHttp::HtmlEncode(const FString& UnencodedString)
{
...
FString FGenericPlatformJusticeHttp::GetUrlDomain(const FString& Url)
{
	FString Protocol;
	FString Domain = Url;
...
FString FGenericPlatformJusticeHttp::GetMimeType(const FString& FilePath)
{
...
FString FGenericPlatformJusticeHttp::GetDefaultUserAgent()
{
