...
void FWindowsPlatformJusticeHttp::Init()
{
	if (GConfig)
	{
...
void FWindowsPlatformJusticeHttp::Shutdown()
{
#if WITH_LIBCURL
	if (bUseCurl)
	{
...
FHttpManager * FWindowsPlatformJusticeHttp::CreatePlatformHttpManager()
{
#if WITH_LIBCURL
	if (bUseCurl)
	{
...
IJusticeHttpRequest* FWindowsPlatformJusticeHttp::ConstructRequest()
{
#if WITH_LIBCURL
	if (bUseCurl)
	{
...
FString FWindowsPlatformJusticeHttp::GetMimeType(const FString& FilePath)
{
