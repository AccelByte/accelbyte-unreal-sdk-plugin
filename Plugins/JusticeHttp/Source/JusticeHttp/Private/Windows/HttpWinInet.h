 ...
 */
class FHttpRequestWinInet : public IJusticeHttpRequest
{
 ...
 */
class FHttpResponseWinInet : public IJusitceHttpResponse
{
...
public:
	...
	FWinInetConnection()
	:	InternetHandle(NULL)
	,	HttpManager(&FJusticeHttpModule::Get().GetHttpManager())
	{
	}
