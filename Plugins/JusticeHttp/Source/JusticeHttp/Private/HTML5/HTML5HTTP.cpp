...
FHTML5HttpRequest::FHTML5HttpRequest()
	...
	,	ElapsedTime(0.0f)
{
	UE_LOG(LogJusticeHttp, Verbose, TEXT("FHTML5HttpRequest::FHTML5HttpRequest()"));
}
...
{
	UE_LOG(LogJusticeHttp, Verbose, TEXT("FHTML5HttpRequest::GetURL() - %s"), *URL);
	return URL;
}
...
{
	UE_LOG(LogJusticeHttp, Verbose, TEXT("FHTML5HttpRequest::SetURL() - %s"), *InURL);
	URL = InURL;
}
...
{
	UE_LOG(LogJusticeHttp, Verbose, TEXT("FHTML5HttpRequest::GetURLParameter() - %s"), *ParameterName);
...
{
	UE_LOG(LogJusticeHttp, Verbose, TEXT("FHTML5HttpRequest::GetHeader() - %s"), *HeaderName);
...
{
	UE_LOG(LogJusticeHttp, Verbose, TEXT("FHTML5HttpRequest::SetHeader() - %s / %s"), *HeaderName, *HeaderValue);
...
{
	UE_LOG(LogJusticeHttp, Verbose, TEXT("FHTML5HttpRequest::GetAllHeaders()"));
...
{
	UE_LOG(LogJusticeHttp, Verbose, TEXT("FHTML5HttpRequest::GetContent()"));
...
{
	UE_LOG(LogJusticeHttp, Verbose, TEXT("FHTML5HttpRequest::SetContent()"));
...
int32 FHTML5HttpRequest::GetContentLength()
{
	...
	UE_LOG(LogJusticeHttp, Verbose, TEXT("FHTML5HttpRequest::GetContentLength() - %i"), Len);
...
{
	UE_LOG(LogJusticeHttp, Verbose, TEXT("FHTML5HttpRequest::SetContentAsString() - %s"), *ContentString);
...
{
	UE_LOG(LogJusticeHttp, Verbose, TEXT("FHTML5HttpRequest::SetVerb() - %s"), *InVerb);
...
{
	UE_LOG(LogJusticeHttp, Verbose, TEXT("FHTML5HttpRequest::StaticReceiveDataCallback()"));
...
{
	UE_LOG(LogJusticeHttp, Verbose, TEXT("FHTML5HttpRequest::ReceiveDataCallback()"));
	UE_LOG(LogJusticeHttp, Verbose, TEXT("Response size: %d"), size);
	...
	if (Response.IsValid())
	{
		...
		while (Header.Split(TEXT("\n"), &HeaderChunk, &HeaderLeftovers))
		{
			...
			{
				UE_LOG(LogJusticeHttp, Verbose, TEXT("%p: Received response header '%s'."), this, *HeaderChunk);
		...
		// save
		UE_LOG(LogJusticeHttp, Verbose, TEXT("Saving payload..."));

		FMemory::Memcpy(static_cast<uint8*>(Response->Payload.GetData()), buffer, size);
		Response->TotalBytesRead = size;
		Response->HttpCode = 200;

		UE_LOG(LogJusticeHttp, Verbose, TEXT("Payload length: %d"), Response->Payload.Num());
...
{
	UE_LOG(LogJusticeHttp, Verbose, TEXT("FHTML5HttpRequest::StaticErrorDataCallback()"));
...
{
	UE_LOG(LogJusticeHttp, Verbose, TEXT("FHTML5HttpRequest::ErrorDataCallback() HttpStatusCode: %d"), httpStatusCode);
...
{
	UE_LOG(LogJusticeHttp, Verbose, TEXT("FHTML5HttpRequest::StaticProgressCallback()"));
...
{
	UE_LOG(LogJusticeHttp, Verbose, TEXT("FHTML5HttpRequest::ProgressCallback()"));
	...
	UE_LOG(LogJusticeHttp, Verbose, TEXT("Loaded: %d, Total: %d"), Loaded, Total);
}
...
bool FHTML5HttpRequest::StartRequest()
{
	...
	{
		UE_LOG(LogJusticeHttp, Log, TEXT("TODO: PUT"));
	...
	{
		UE_LOG(LogJusticeHttp, Log, TEXT("TODO: HEAD"));
	...
	else if (Verb == TEXT("DELETE"))
	{
		...
		UE_LOG(LogJusticeHttp, Log, TEXT("TODO: DELETE"));
		return false;
	}
	else
	{
		UE_LOG(LogJusticeHttp, Fatal, TEXT("Unsupported verb '%s"), *Verb);
...
{
	UE_LOG(LogJusticeHttp, Verbose, TEXT("FHTML5HttpRequest::ProcessRequest()"));

	if (!StartRequest())
	{
		UE_LOG(LogJusticeHttp, Warning, TEXT("Processing HTTP request failed. Increase verbosity for additional information."));
	...
	UE_LOG(LogJusticeHttp, Verbose, TEXT("Request is waiting for processing"), this );

	return true;
}


FJusticeHttpRequestCompleteDelegate& FHTML5HttpRequest::OnProcessRequestComplete()
{
	UE_LOG(LogJusticeHttp, Verbose, TEXT("FHTML5HttpRequest::OnProcessRequestComplete()"));
	return RequestCompleteDelegate;
}

FJusticeHttpRequestProgressDelegate& FHTML5HttpRequest::OnRequestProgress()
{
	UE_LOG(LogJusticeHttp, Verbose, TEXT("FHTML5HttpRequest::OnRequestProgress()"));
	return RequestProgressDelegate;
}

void FHTML5HttpRequest::FinishedRequest()
{
	UE_LOG(LogJusticeHttp, Verbose, TEXT("FHTML5HttpRequest::FinishedRequest()"));
	...
	if (bCompleted)
	{
		if (Response.IsValid())
		{
			Response->bSucceeded = EJusticeHttpResponseCodes::IsOk(Response->HttpCode);
	...
	if (Response.IsValid() &&
		Response->bSucceeded)
	{
		UE_LOG(LogJusticeHttp, Verbose, TEXT("%p: request has been successfully processed. HTTP code: %d, content length: %d, actual payload size: %d"), 
...
{
	UE_LOG(LogJusticeHttp, Verbose, TEXT("FHTML5HttpRequest::CleanupRequest()"));
...
{
	UE_LOG(LogJusticeHttp, Verbose, TEXT("FHTML5HttpRequest::CancelRequest()"));
	bCanceled = true;
}


EJusticeHttpRequestStatus::Type FHTML5HttpRequest::GetStatus()
{
	UE_LOG(LogJusticeHttp, Verbose, TEXT("FHTML5HttpRequest::GetStatus()"));
	return CompletionStatus;
}

const FJusticeHttpResponsePtr FHTML5HttpRequest::GetResponse() const
{
	UE_LOG(LogJusticeHttp, Verbose, TEXT("FHTML5HttpRequest::GetResponse()"));
	return Response;
}
...
{
	UE_LOG(LogJusticeHttp, Verbose, TEXT("FHTML5HttpResponse::~FHTML5HttpResponse()"));
}


FString FHTML5HttpResponse::GetURL()
{
	UE_LOG(LogJusticeHttp, Verbose, TEXT("FHTML5HttpResponse::GetURL()"));
...
{
	UE_LOG(LogJusticeHttp, Verbose, TEXT("FHTML5HttpResponse::GetURLParameter()"));
...
{
	UE_LOG(LogJusticeHttp, Verbose, TEXT("FHTML5HttpResponse::GetHeader()"));
...
{
	UE_LOG(LogJusticeHttp, Verbose, TEXT("FHTML5HttpResponse::GetAllHeaders()"));
...
{
	UE_LOG(LogJusticeHttp, Verbose, TEXT("FHTML5HttpResponse::GetContentType()"));
...
{
	UE_LOG(LogJusticeHttp, Verbose, TEXT("FHTML5HttpResponse::GetContentLength()"));
...
{
	UE_LOG(LogJusticeHttp, Verbose, TEXT("FHTML5HttpResponse::GetContent()"));
...
{
	UE_LOG(LogJusticeHttp, Verbose, TEXT("FHTML5HttpResponse::GetContentAsString()"));
...
{
	UE_LOG(LogJusticeHttp, Verbose, TEXT("FHTML5HttpResponse::GetResponseCode()"));
...
bool FHTML5HttpResponse::IsReady()
{
	if (bIsReady)
	{
		UE_LOG(LogJusticeHttp, Verbose, TEXT("FHTML5HttpResponse::IsReady()"));
	}
